...
# frozen
from diffusers.pipelines.stable_diffusion import FrozenDict
from diffusers.pipelines.stable_diffusion import VaeImageProcessor
...
class V2Variation(DiffusionPipeline, LoraLoaderMixin):
    def __init__(
        self,
        vae: AutoencoderKL,
